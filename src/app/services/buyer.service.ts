...
export class BuyerService {
  ...
  buyerTableFields: Field[] = [
    { field: 'username', header: 'Buyer ID', size:50, sizeP:50,sorting:true ,showColumn:true, cellRenderer: BuyerRenderer},
    ...
    { field: 'stage', header: 'Stage', size:50, sizeP:50 ,filterList:this.masterStageList,sorting:true,searchable:true,showColumn:true},
    { field: 'dispositionStatus', header: 'Latest Disposition', size:50, sizeP:50,filterList:[] ,showColumn:true},
    { field: 'participation_status', header: 'Buyer Status', size:50, sizeP:50 ,filterList:this.masterParticipationList,showColumn:true,cellRenderer: BuyerRenderer},
    ...
    { field: 'phone-icon', header: '', size:50, sizeP:10,cellRenderer: BuyerRenderer, showColumn:true},
    { field: 'three-dot-icon', header: '', size:50, sizeP:10,cellRenderer: BuyerRenderer, showColumn:true},
  ];
